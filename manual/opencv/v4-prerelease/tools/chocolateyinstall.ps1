...
$url        = 'https://github.com/opencv/opencv/releases/download/4.0.0-rc/opencv-4.0.0-rc-vc14_vc15.exe'
$checksum = '954B558363903213C954F38F3E63560415DB2EF1672B63770F399F5FAE19ADF3'
$checksumType = 'sha256'
