...
$url        = 'https://github.com/opencv/opencv/releases/download/4.0.0-alpha/opencv-4.0.0-alpha-vc14_vc15.exe'
$checksum = '999139E935572B51F7EA53FC0AF4DDD7BA75BFC2083925F5AEE6CA41E4DABD4B'
$checksumType = 'sha256'
