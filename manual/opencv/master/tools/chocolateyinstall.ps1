...
$url        = 'https://github.com/opencv/opencv/releases/download/4.0.0/opencv-4.0.0-vc14_vc15.exe'
$checksum = '95C0D00204D836F20669B58029DD201C9BD9177F28AACCFA5808648C63E27343'
$checksumType = 'sha256'
