...
$url        = 'https://github.com/opencv/opencv/releases/download/4.1.1/opencv-4.1.1-vc14_vc15.exe'
$checksum = '55F3BA28A903118E2A4AB7A3F062226EDA9546CFF2EE89FB63CF78BD5A223006'
$checksumType = 'sha256'
