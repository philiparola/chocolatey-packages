...
$url        = 'https://github.com/opencv/opencv/releases/download/3.3.1/opencv-3.3.1-vc14.exe'
$checksum = '17177F7E59F623D3690486F1C27A7529E95D2A7724912F7AF3B03B1C3E9FE9D2'
$checksumType = 'sha256'
