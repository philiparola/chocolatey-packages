...
$url        = 'https://github.com/opencv/opencv/releases/download/4.1.0/opencv-4.1.0-vc14_vc15.exe'
$checksum = '185A02DAE7A6E78173646D6A901FA4C50DB61C0BBDFCA27B79845A6BCBBE1F94'
$checksumType = 'sha256'
