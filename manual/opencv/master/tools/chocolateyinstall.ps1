...
$url        = 'https://github.com/opencv/opencv/releases/download/3.4.0/opencv-3.4.0-vc14_vc15.exe'
$checksum = '709F84981468C8F5E458BCD4B1E960B3BBB3A177F2BCB9093E707133D0C89E3B'
$checksumType = 'sha256'
