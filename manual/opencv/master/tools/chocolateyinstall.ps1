...
$url        = 'https://github.com/opencv/opencv/releases/download/3.4.3/opencv-3.4.3-vc14_vc15.exe'
$checksum = 'CF76771459C391C64345B3A35326792F2BB59AE8A5D00BA93DE2921E8A1C50D8'
$checksumType = 'sha256'
