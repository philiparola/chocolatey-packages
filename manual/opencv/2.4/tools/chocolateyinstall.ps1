...
$url        = 'https://sourceforge.net/projects/opencvlibrary/files/opencv-win/2.4.13/opencv-2.4.13.5-vc14.exe/download'
$checksum = '18825B9C7CB698EE702EDA610F43299F48680A395BAD5C2A27A8DFDBBB79A994'
$checksumType = 'sha256'
