...
$url        = 'https://github.com/opencv/opencv/releases/download/2.4.13.3/opencv-2.4.13.3-vc14.exe'
$checksum = '9331AAF481F05DAC064FDC950337D3D6C827957379F2056D13412EDD2C476089'
$checksumType = 'sha256'
