...
$url        = 'https://github.com/opencv/opencv/releases/download/3.4.7/opencv-3.4.7-vc14_vc15.exe'
$checksum = 'EC44FA65D2103DEFFC9B6F216A03D1403AD6CF8678A8F389EA0FFC4A063B4C1C'
$checksumType = 'sha256'
