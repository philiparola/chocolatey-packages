...
$url        = 'https://github.com/opencv/opencv/releases/download/3.4.4/opencv-3.4.4-vc14_vc15.exe'
$checksum = '4CC62F92EF72F0796B853C8915AB4C9EE243E15D722929F892ACCC6EF1CD80CE'
$checksumType = 'sha256'
