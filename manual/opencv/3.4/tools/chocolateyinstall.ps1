...
$url        = 'https://github.com/opencv/opencv/releases/download/3.4.8/opencv-3.4.8-vc14_vc15.exe'
$checksum = '22B12834358B0FB86B4C862C85BDBD13A737ED3BBB6759782BFE5864F7505A72'
$checksumType = 'sha256'
